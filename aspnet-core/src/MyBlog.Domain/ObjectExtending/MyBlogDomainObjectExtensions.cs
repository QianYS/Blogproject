...
namespace MyBlog.ObjectExtending
{
    public static class MyBlogDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the MyBlogEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
